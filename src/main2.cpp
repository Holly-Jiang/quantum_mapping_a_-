...
// 		cout << "  q" << i << " is initially mapped to Q" << loc[i] << endl;
// 	}
// }
...
int main(int argc, char** argv) {
	...
	for(int i = 0; i < nqubits; i++) {
		...
		std::ifstream inifile("E:\\github\\VF2\\data\\graphDB\\ini_map1.my");
		read_ini(inifile);
